...
// 修改
// 将公钥序列化为某种格式的der编码
// 这里没改干净, 不同名称的pqc算法的公钥类型一样(pqc.PublicKey),
// 想一想在哪里改写, 怎么改写
...
//func test(requestedSigAlgo SignatureAlgorithm) {
//	// 从签名oid -> 公钥oid
//
//
...
func CreateCertificate(rand io.Reader, template, parent *Certificate, pub, priv interface{}) (cert []byte, err error) {
	...
	//fmt.Println(pub)
	//fmt.Println(len(pub))
	//fmt.Println("pk info: ", c.PublicKey.PublicKey.BitLength)
