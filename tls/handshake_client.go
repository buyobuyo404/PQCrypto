...
func certificateRequestInfoFromMsg(ctx context.Context, vers uint16, certReq *certificateRequestMsg) *CertificateRequestInfo {
	...
	for _, sigScheme := range certReq.supportedSignatureAlgorithms {
		...
		case signatureECDSA, signatureEd25519,
			...
			signatureDilithium2AES, signatureDilithium3AES, signatureDilithium5AES,
			signatureRainbowIIIClassic, signatureRainbowIIICircumzenithal, signatureRainbowIIICompressed,
			signatureRainbowVClassic, signatureRainbowVCircumzenithal, signatureRainbowVCompressed:
